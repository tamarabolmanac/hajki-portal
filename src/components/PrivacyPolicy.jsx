      ...
      <div className="page-container" style={{ maxWidth: 760 }}>
        ...
        <div className="glass-card">
          ...
          <Section title="1. Ko smo">
            Hajki je aplikacija za planinare i ljubitelje prirode koja omogućava snimanje i deljenje planinskih ruta u Srbiji. Aplikaciju razvija i održava tim Hajki. Za sva pitanja u vezi sa privatnošću možete nas kontaktirati putem stranice <strong style={{ color: '#38ef7d' }}>hajki.com/contact</strong>.
          </Section>
          ...
          <Section title="3. Kako koristimo podatke">
            <ul style={{ margin: 0, paddingLeft: '1.25rem' }}>
              ...
              <li>Izračunavanje statistika: pređena kilometraža, vreme u prirodi, broj ruta.</li>
