...
/* Content lives here in both languages; `lang` from I18nProvider picks one.
   Keep the two in sync when editing. */
const CONTENT = {
  sr: {
    title: 'Politika privatnosti',
    updated: 'Poslednje ažuriranje: 10. jula 2026.',
    contact: 'Za pitanja:',
    sections: [
      {
        h: '1. Ko smo',
        body: (
          <>Hajki je aplikacija za planinare i ljubitelje prirode koja omogućava snimanje i deljenje planinskih ruta u Srbiji. Aplikaciju razvija i održava tim Hajki. Za sva pitanja u vezi sa privatnošću možete nas kontaktirati putem stranice <Em>hajki.com/contact</Em>.</>
        ),
      },
      {
        h: '2. Koji podaci se prikupljaju',
        body: (
          <>
      ...
      {
        h: '3. Kako koristimo podatke',
        body: (
          <Ul items={[
            { t: 'Prikaz vaših završenih ruta zajednici u okviru aplikacije.' },
            { t: 'Izračunavanje statistika: pređena kilometraža, vreme u prirodi, broj ruta.' },
      ...
      {
        h: '10. Izmene politike privatnosti',
        body: (
    ...
    sections: [
      {
        h: '1. Who we are',
        body: (
          <>Hajki is an app for hikers and nature lovers that lets you record and share hiking routes in Serbia. The app is developed and maintained by the Hajki team. For any privacy-related questions, contact us via <Em>hajki.com/contact</Em>.</>
        ),
      },
      {
      ...
      },
      {
        ...
        body: (
          <Ul items={[
            ...
            { t: 'Calculating statistics: distance covered, time in nature, number of routes.' },
